...
const ExperienceCard = ({ experience, isLast }: { experience: typeof experienceData[0], isLast: boolean }) => {
    return (
        <div className="flex gap-x-3">
            <div className="relative last:after:hidden after:absolute after:top-7 after:bottom-0 after:start-3.5 after:w-px after:-translate-x-[0.5px] after:bg-blue-500/30">
            ...
            >
                <div className="card-ui p-6">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2">
                        <h3 className="text-xl font-semibold brand-text mb-1 sm:mb-0">{experience.title}</h3>
            ...
            <div className="container mx-auto z-10 relative px-4">
                ...
                <div className="max-w-3xl mx-auto">
                    {experienceData.map((exp, index) => (
                        <ExperienceCard key={index} experience={exp} isLast={index === experienceData.length - 1} />
                    ))}
                </div>
            </div>
        </section>
